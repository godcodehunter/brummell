...
export const MinusInSquare = (props: React.SVGProps<SVGSVGElement>) => (
...
export const PlusInSquare = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} viewBox="64 -65 897 897">
        <g>
        <path
...
export const CloseInSquare = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} viewBox="64 -65 897 897">
      <g>
        <path
